...
class AddressList:
    ...
    g_TOTAL_FIRE_BOMB: int
    g_TOTAL_ELECTRIC_BOMB: int
    g_TOTAL_WATER_BOMB: int
    g_TOTAL_ICE_BOMB: int
    g_MW_SEED: int
    g_INIT: int
    g_BOSS_COSTS: int
    g_LG_DOOR_COSTS: int
...
class G5SE7D(AddressList):
    ...
    p_TOTAL_FIRE_BOMB = 0x803d8fda
    p_TOTAL_ELECTRIC_BOMB = 0x803d8fdb
    p_TOTAL_WATER_BOMB = 0x803d8fdc
    p_TOTAL_ICE_BOMB = 0x803d8fdd
    p_DEATHLINK_RECV = 0x803d8fde
    p_DEATHLINK_SEND = 0x803d8fdf
    ...
    p_PATCH_BEEN_WRITTEN_TO = 0x803d8fe5
    ...
    g_TOTAL_FIRE_BOMB = 0x80467d16
    g_TOTAL_ELECTRIC_BOMB = 0x80467d17
    g_TOTAL_WATER_BOMB = 0x80467d18
    g_TOTAL_ICE_BOMB = 0x80467d19
    g_DEATHLINK_RECV = 0x80467d1a
    g_DEATHLINK_SEND = 0x80467d1b
    ...
    g_PATCH_BEEN_WRITTEN_TO = 0x80467d21
