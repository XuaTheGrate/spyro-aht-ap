...
class G5SE7D(AddressList):
    ...
    p_NUM_FIRE_AMMO_RECEIVED = 0x803d8fda
    p_NUM_ELECTRIC_AMMO_RECEIVED = 0x803d8fdb
    p_NUM_WATER_AMMO_RECEIVED = 0x803d8fdc
    p_NUM_ICE_AMMO_RECEIVED = 0x803d8fdd
    p_DEATHLINK_INGOING = 0x803d8fde
    p_DEATHLINK_OUTGOING = 0x803d8fdf
    p_INFINITE_BUTTERFLY_JAR = 0x803d8fe0
    p_SKIP_CUTSCENE_BUTTON = 0x803d8fe1
    p_ALLOW_TELEPORT_TO_HUB = 0x803d8fe2
    p_ALLOW_IMMEDIATE_REALM_ACCESS = 0x803d8fe3
    p_DISABLE_POPUPS = 0x803d8fe4
    p_INSTANT_ELEVATORS = 0x803d8fe5
    p_PATCH_BEEN_WRITTEN_TO = 0x803d8fe6
    p_MW_SEED = 0x803d8fe8
    p_INIT = 0x803d8fec
    p_BOSS_COSTS = 0x803d8ff0
    p_LG_DOOR_COSTS = 0x803d8ff4
    p_XLS_SHOP_SHEETCOUNT_ALWAYS_1 = 0x803d8ff8
    p_XLS_SHOP_SHEET_OFFSET_ALWAYS_4 = 0x803d8ffc
    p_XLS_SHOP_ROWCOUNT = 0x803d9000
    p_XLS_SHOP_ITEMS = 0x803d9004
    p_SHOP_TEXT = 0x803d9a04

    g_LOCATION_BITFIELD = 0x80467ce4
    g_NUM_GEM_PACKS_RECEIVED = 0x80467d14
    g_NUM_LOCK_PICKS_RECEIVED = 0x80467d15
    g_NUM_FIRE_AMMO_RECEIVED = 0x80467d16
    g_NUM_ELECTRIC_AMMO_RECEIVED = 0x80467d17
    g_NUM_WATER_AMMO_RECEIVED = 0x80467d18
    g_NUM_ICE_AMMO_RECEIVED = 0x80467d19
    g_DEATHLINK_INGOING = 0x80467d1a
    g_DEATHLINK_OUTGOING = 0x80467d1b
    g_INFINITE_BUTTERFLY_JAR = 0x80467d1c
    g_SKIP_CUTSCENE_BUTTON = 0x80467d1d
    g_ALLOW_TELEPORT_TO_HUB = 0x80467d1e
    g_ALLOW_IMMEDIATE_REALM_ACCESS = 0x80467d1f
    g_DISABLE_POPUPS = 0x80467d20
    g_INSTANT_ELEVATORS = 0x80467d21
    g_PATCH_BEEN_WRITTEN_TO = 0x80467d22
    g_MW_SEED = 0x80467d24
    g_INIT = 0x80467d28
    g_BOSS_COSTS = 0x80467d2c
    g_LG_DOOR_COSTS = 0x80467d30
    g_XLS_SHOP_SHEETCOUNT_ALWAYS_1 = 0x80467d34
    g_XLS_SHOP_SHEET_OFFSET_ALWAYS_4 = 0x80467d38
    g_XLS_SHOP_ROWCOUNT = 0x80467d3c
    g_XLS_SHOP_ITEMS = 0x80467d40
    g_SHOP_TEXT = 0x80468740
