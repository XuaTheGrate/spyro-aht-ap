...
from rule_builder.rules import CanReachLocation, CanReachRegion, Has, HasAll, HasAllCounts, HasAny, HasAnyCount, Rule, True_

from .options import MiscAllowImmediateRealmAccess
...
REGIONS = {r.name: r for r in [
    ...
    DataRegion("Dragon Village - After Elder Tomas", ["Dragon Village - Gnasty Gnorcs Lair", "Crocoville Swamp", "Dragonfly Falls"], [
        ...
        DataLocation("Dragon Village: Locked Chest near Ball Gadget", 6, Has("Glide")),
        DataLocation("Dragon Village: Locked Chest on Cliff", 7, True_()),
        ...
        DataLocation("Dragon Village: Locked Chest before Crocoville Swamp", 15, True_()),
    ...
    DataRegion("Crocoville Swamp", ["Crocoville Swamp - After Elder Magnus"], [
        ...
        DataLocation("Crocoville Swamp: Locked Chest behind breakable wall", 19, Has("Charge")),
        ...
        DataLocation("Crocoville Swamp: Locked Chest before Dogs", 23, True_()),
        DataLocation("Crocoville Swamp: Locked Chest in Temple", 24, HasAny("Fire Breath", "Lightning Breath", "Charge")),
    ...
    DataRegion("Dragonfly Falls", ["Dragonfly Falls - Vulture Dark Gem"], [
        DataLocation("Dragonfly Falls: Locked Chest near Ball Gadget", 40, Has("Glide")),
        ...
        DataLocation("Dragonfly Falls: Light Gem behind reinforced wall", 43, Has("Glide")),
    ], access_rule=Has("Light Gem", 8)),

    # Double Jump (via Dragon Village - After Elder Tomas)
    # Light Gem x8 (via Dragonfly Falls)
    DataRegion("Dragonfly Falls - Vulture Dark Gem", ["Dragonfly Falls - 70 Light Gem Door"], [
        ...
        DataLocation("Dragonfly Falls: Locked Chest in Piranha Pool", 52, True_()),
    ...
    # Double Jump (via Dragon Village - After Elder Tomas)
    # Light Gem x8 (via Dragonfly Falls)
    # Glide (via Dragonfly Falls - Vulture Dark Gem)
    ...
    DataRegion("Coastal Remains", ["Coastal Remains - Cloudy Domain Entrance", "Coastal Remains - After Otto", "Coastal Remains - 20 Light Gem Door", "Coastal Remains - After Cannon Dark Gem", "Coastal Remains - Ineptunes Lair"], [
        ...
        DataLocation("Coastal Remains: Locked Chest behind Moneybags", 234, True_()),
        DataLocation("Coastal Remains: Locked Chest hidden on beach", 235, True_())
    ], access_rule=(
    ...
    DataRegion("Cloudy Domain", ["Cloudy Domain - After Elder Titan"], [
        DataLocation("Cloudy Domain: Locked Chest at entrance", 80, True_()),
    ...
    DataRegion("Cloudy Domain - After Elder Titan", ["Cloudy Domain - Wing Shield"], [
        ...
        DataLocation("Cloudy Domain: Locked Chest beyond Reinforced Door", 85, Has("Light Gem", 40)),
        DataLocation("Cloudy Domain: Locked Chest after Crossroads left", 87, True_()),
    ...
    DataRegion("Cloudy Domain - Wing Shield", [], [
        DataLocation("Cloudy Domain: Locked Chest in Wing Shield Tutorial", 236, True_()),
    ...
    DataRegion("Sunken Ruins", ["Sunken Ruins - Invulnerability Gadget"], [
        ...
        DataLocation("Sunken Ruins: Locked Chest at entrance", 237, True_()),
        DataLocation("Sunken Ruins: Locked Chest behind Swim Exit", 99, True_()),
        DataLocation("Sunken Ruins: Dark Gem after Swim", 100, True_()),
        DataLocation("Sunken Ruins: Dragon Egg above Dark Gem", 101, Has("Glide")),
        DataLocation("Sunken Ruins: Locked Chest above Dark Gem", 102, Has("Glide")),
        DataLocation("Sunken Ruins: Locked Chest behind Lily", 103, True_()),
        ...
        DataLocation("Sunken Ruins: Locked Chest near fish", 108, True_()),
    ...
    DataRegion("Sunken Ruins - Invulnerability Gadget", [], [
        ...
        DataLocation("Sunken Ruins: Locked Chest after Dark Gem", 112, True_()),
        DataLocation("Sunken Ruins: Dark Gem under Acid Pool", 113, True_()),
        DataLocation("Sunken Ruins: Locked Chest near Acid Pool Dark Gem", 114, True_()),
        DataLocation("Sunken Ruins: Locked Chest after Acid Pool Dark Gem", 115, True_())
    ...
    DataRegion("Frostbite Village - After Phils Gate", [], [
        ...
        DataLocation("Frostbite Village: Locked Chest by Dragon Egg", 238, Has("Double Jump"))
    ...
    DataRegion("Gloomy Glacier", ["Ice Citadel"], [
        DataLocation("Gloomy Glacier: Locked Chest in Bentleys Living Room", 239, True_()),
        DataLocation("Gloomy Glacier: Locked Chest in Bentleys Bedroom", 137, True_()),
        DataLocation("Gloomy Glacier: Reward from Bentley", 138, True_()),
        DataLocation("Gloomy Glacier: Light Gem in Ambush room", 139, True_()),
        DataLocation("Gloomy Glacier: Locked Chest after Ambush room", 140, True_()),
    ...
    DataRegion("Ice Citadel", ["Ice Citadel - Inner"], [
        DataLocation("Ice Citadel: Locked Chest in entrance", 240, True_()),
    ...
    DataRegion("Ice Citadel - Inner", ["Ice Citadel - Above Elder Astor"], [
        DataLocation("Ice Citadel: Locked Chest behind breakable wall", 153, Has("Charge"))
    ...
    DataRegion("Ice Citadel - After Elder Astor", ["Frostbite Village - Reinforced Door"], [
        DataLocation("Ice Citadel: Locked Chest after Elder Astor", 156, True_()),
        ...
        DataLocation("Ice Citadel: Locked Chest in supercharge tunnel", 241, True_()),
        DataLocation("Ice Citadel: Locked Chest before reinforced wall", 242, True_()),
        ...
        DataLocation("Ice Citadel: Locked Chest by Ice Princess", 243, True_()),
    ...
    DataRegion("Frostbite Village - Reinforced Door", ["Frostbite Village - 95 Light Gem Door"], [
        ...
        DataLocation("Frostbite Village: Locked Chest in falling icicles room", 128, True_()),
        DataLocation("Frostbite Village: Light Gem after falling icicles", 129, Has("Pole Spin")),
        DataLocation("Frostbite Village: Locked Chest under platform after falling icicles", 244, True_())
    ...
    DataRegion("Frostbite Village - 95 Light Gem Door", [], [
        DataLocation("Frostbite Village: Locked Chest beyond 95 Light Gem Door", 133, True_()),
    ...
    DataRegion("Stormy Beach", ["Molten Mount"], [
        DataLocation("Stormy Beach: Locked Chest 1 in left cove by teleporter", 245, True_()),
        DataLocation("Stormy Beach: Locked Chest 2 in left cove by teleporter", 246, True_()),
        ...
        DataLocation("Stormy Beach: Locked Chest by Wally", 247, Has("Double Jump")),
        ...
        DataLocation("Stormy Beach: Locked Chest after armored Gnorc", 248, Has("Double Jump")),
        DataLocation("Stormy Beach: Locked Chest guarded by crossbow Gnorcs", 249, HasAll("Glide", "Double Jump", "Wall Kick")),
    ...
    DataRegion("Molten Mount", ["Molten Mount - Pole Spin"], [
        ...
        DataLocation("Molten Mount: Locked Chest next to Sgt. Byrd", 183, True_()),
    ...
    DataRegion("Molten Mount - Pole Spin", ["Magma Falls Top"], [
        ...
        DataLocation("Molten Mount: Locked Chest behind breakable wall", 188, Has("Charge")),
        DataLocation("Molten Mount: Dragon Egg from thief", 189, Has("Charge")),
        DataLocation("Molten Mount: Locked Chest in thief room", 250, True_()),
        DataLocation("Molten Mount: Locked Chest behind breakable wall near end of zone", 190, Has("Charge")),
    ...
    DataRegion("Magma Falls Top", ["Magma Falls - Ball Gadget"], [
        ...
        DataLocation("Magma Falls Top: Locked Chest behind Moneybags", 193, Has("Charge")),
        DataLocation("Magma Falls Top: Locked Chest above Imps", 251, True_())
    ], access_rule=Has("Wall Kick")),
    ...
    DataRegion("Magma Falls Bottom", ["Dark Mine"], [
        ...
        DataLocation("Magma Falls Bottom: Locked Chest after Dark Gem", 199, True_()),
    ...
    DataRegion("Dark Mine", ["Dark Mine - 45 Light Gem Door", "Dark Mine - Steam Vents"], [
        DataLocation("Dark Mine: Locked Chest at entrance", 252, True_()),
        DataLocation("Dark Mine: Locked Chest by bear traps", 206, True_()),
        DataLocation("Dark Mine: Locked Chest glide from Green Robo-Gnorc", 207, True_()),
    ...
    DataRegion("Red's Laboratory", [], [
        DataLocation("Red's Laboratory: Locked Chest after pole spin", 253, True_()),
        DataLocation("Red's Laboratory: Locked Chest above 4 charge switches", 254, True_()),
