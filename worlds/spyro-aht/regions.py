...
REGIONS = {r.name: r for r in [
    ...
    DataRegion("Dragonfly Falls - Vulture Dark Gem", ["Dragonfly Falls - 70 Light Gem Door"], [
        ...
        DataLocation("Dragonfly Falls: Light Gem behind breakable wall in large pool", 47, _builder_all(Charge=1,Swim=1)),
        ...
        # Can be reached without Swim, but i find it better to include it
        DataLocation("Dragonfly Falls: Light Gem in Piranha Pool", 51, _builder_all(Swim=1)),
        DataLocation("Dragonfly Falls: Light Gem in Locked Chest in Piranha Pool", 52, _DEFAULT_RULE),
    ...
    # TODO: determine whether all regions will be unlocked by default or via a toggle in the yaml
    # Implied: Double Jump
    DataRegion("Coastal Remains", ["Coastal Remains - Cloudy Domain Entrance", "Coastal Remains - After Otto", "Coastal Remains - 20 Light Gem Door", "Coastal Remains - After Cannon Dark Gem", "Coastal Remains - Ineptunes Lair"], [
        ...
        DataLocation("Coastal Remains: Dragon Egg from Turtle Mother", 63, _DEFAULT_RULE),
        DataLocation("Coastal Remains: Light Gem from Turtle Mother", 64, _DEFAULT_RULE),
        DataLocation("Coastal Remains: Dark Gem in cannon room", 65, _builder_all(Glide=1)),
        DataLocation("Coastal Remains: Light Gem at beach above water mill", 69, _builder_all(**{"Water Breath": 1})),
        DataLocation("Coastal Remains: Dragon Egg after Piranha pool", 78, _DEFAULT_RULE)
    ], access_rule=_DEFAULT_RULE),
    ...
    # Implied: Double Jump, 20x Light Gem
    ...
    ], access_rule=_builder_all(**{"Pole Spin":1}, Glide=1)),
    ...
    DataRegion("Cloudy Domain - After Elder Titan", ["Cloudy Domain - Wing Shield"], [
        ...
        DataLocation("Cloudy Domain: Locked Chest at Crossroads", 87, _DEFAULT_RULE),
        DataLocation("Cloudy Domain: Light Gem after platforming at Crossroads", 88, _DEFAULT_RULE)
    ...
    DataRegion("Cloudy Domain - Wing Shield", [], [
        ...
        DataLocation("Cloudy Domain: Light Gem after temporary platforms at Crossroads", 89, _DEFAULT_RULE),
        DataLocation("Cloudy Domain: Dragon Egg on temporary platform after Crossroads left", 90, _DEFAULT_RULE),
    ...
    # Implied: Double Jump, Pole Spin, Swim, Charge
    DataRegion("Sunken Ruins", ["Sunken Ruins - Invulnerability Gadget"], [
        ...
        DataLocation("Sunken Ruins: Light Gem after fish", 109, _DEFAULT_RULE)
    ], access_rule=_builder_all(Charge=1)),

    # Implied: Double Jump, Pole Spin, Swim, Charge, Lightning Breath, 24x Light Gems
    ...
    DataRegion("Gloomy Glacier", ["Ice Citadel"], [
        DataLocation("Gloomy Glacier: Locked Chest in Bentleys Home", 137, _DEFAULT_RULE),
    ...
    DataRegion("Stormy Beach", ["Molten Mount"], [
        DataLocation("Stormy Beach: Light Gem in large area left of teleporter", 173, _DEFAULT_RULE),
        DataLocation("Stormy Beach: Dragon Egg from thief underneath Moneybags", 174, _builder_all(Charge=1)),
        DataLocation("Stormy Beach: Dragon Egg from Wally", 175, _DEFAULT_RULE),
        DataLocation("Stormy Beach: Light Gem from Wally", 176, _DEFAULT_RULE),
        DataLocation("Stormy Beach: Dark Gem at entrance to volcano", 177, _DEFAULT_RULE)
    ], access_rule=_builder_all(Glide=1)),
    ...
    ], access_rule=_builder_any(**{"Water Breath": 1, "Ice Breath": 1})),
    ...
    # Implied: Double Jump, Glide, Water Breath OR Ice Breath, Pole Spin, Wall Kick
    ...
    # Implied: Double Jump, Glide, Water Breath OR Ice Breath, Pole Spin, Wall Kick, 8x Light Gems
    ...
    # Implied: Double Jump, Glide, Water Breath OR Ice Breath, Pole Spin, Wall Kick, 8x Light Gems, Charge, Lightning Breath
    DataRegion("Dark Mine", ["Dark Mine - 45 Light Gem Door", "Dark Mine - Steam Vents"], [
        DataLocation("Dark Mine: Locked Chest 2", 206, _DEFAULT_RULE),
    ...
    # Implied: Double Jump, Glide, Water Breath OR Ice Breath, Pole Spin, Wall Kick, 45x Light Gems, Charge, Lightning Breath, Swim
    ...
    # Implied: Double Jump, Glide, Water Breath, Pole Spin, Wall Kick, 8x Light Gems, Charge, Lightning Breath, Ice Breath,
    ...
    # Implied: Double Jump, Glide, Water Breath, Pole Spin, Wall Kick, 8x Light Gems, Charge, Lightning Breath, Ice Breath, Fire Breath
